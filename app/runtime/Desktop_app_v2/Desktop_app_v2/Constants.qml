...
QtObject {
    ...
    readonly property font appBodyFont: Qt.font({ family: "Segoe UI Variable", pixelSize: Math.round(16 * designTextScale) })
    readonly property font appLabelFont: Qt.font({ family: "Segoe UI Variable", pixelSize: Math.round(15 * designTextScale) })
    readonly property font appButtonFont: Qt.font({ family: "Segoe UI Variable", pixelSize: Math.round(16 * designTextScale), weight: Font.DemiBold })
    readonly property font appSectionFont: Qt.font({ family: "Segoe UI Variable", pixelSize: Math.round(16 * designTextScale), weight: Font.DemiBold })
    readonly property font appCaptionFont: Qt.font({ family: "Segoe UI Variable", pixelSize: Math.round(13 * designTextScale) })
    readonly property font appInspectorRailGlyphFont: Qt.font({ family: "Segoe UI Variable", pixelSize: 14, weight: Font.DemiBold })
