...
Item {
    ...
    Binding { target: screen.trainWorkspace; property: "libraryModelCompatibility"; value: root.trainingController ? root.trainingController.libraryModelCompatibility : ({ "hasCompatibleModels": true, "reasons": [] }) }
