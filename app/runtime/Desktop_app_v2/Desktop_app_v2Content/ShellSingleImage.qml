...
Item {
    ...
    Binding { target: screen.modelTestWorkspace; property: "partialSummaryAvailable"; value: root.modelTestController ? root.modelTestController.partialSummaryUrl.toString() !== "" : state.modelTestPresentation === "interrupted" }
    Binding { target: screen.modelTestWorkspace; property: "partialPredictionsAvailable"; value: root.modelTestController ? root.modelTestController.partialPredictionsCsvUrl.toString() !== "" : state.modelTestPresentation === "interrupted" }
    Binding { target: screen.modelTestWorkspace; property: "recoveryStartEnabled"; value: root.modelTestController ? root.modelTestController.canStart : state.activeOperation === "" }
