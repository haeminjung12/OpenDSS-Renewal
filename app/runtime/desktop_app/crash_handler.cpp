...
LONG WINAPI unhandledExceptionFilter(EXCEPTION_POINTERS* info) {
    ...
    swprintf(fileName, 128, L"droplet_crash_%04d%02d%02d_%02d%02d%02d.dmp", st.wYear, st.wMonth, st.wDay, st.wHour,
    ...
    if (hFile != INVALID_HANDLE_VALUE) {
        ...
        MiniDumpWriteDump(GetCurrentProcess(), GetCurrentProcessId(), hFile, MiniDumpNormal, info ? &mei : nullptr,
                          nullptr, nullptr);
        CloseHandle(hFile);
