...
- Durable `qds.cmake` integration must be restored and the focused Qt Quick test must pass before any production work order for the current slice can launch or be accepted. This gate is not yet passed.
