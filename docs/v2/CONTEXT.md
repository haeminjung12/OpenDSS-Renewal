...
- `UAT-CONFIG-BLK-001` remains unresolved: Channel Reference Line has defined Set/click-horizontal-line/Reset presentation beneath Decision Boundary, but its display-only versus detector/routing role is not decided. No implementation or persistence semantics may be inferred.
