...
- Commit/push and read-only `VG-001` artifact validation are the remaining gates. Repeated physical Escape interruptions blocked Validation before it could rerun the corrected camera identity and continuous-DAQ HIL flows; no additional artifact defect was observed.
