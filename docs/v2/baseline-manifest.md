...
| `docs/v2/design/consolidated-design-draft.md` | **User-Designated Master Specification** | Single controlling product/design authority; verify against `consolidated-design-lock.json`. | `6c73a0a8e2f0674e563ce4931b8a1d88d56b4efde5a780d6fb5c2e60020905e9` |
