...
| `docs/v2/design/consolidated-design-draft.md` | **User-Designated Master Specification** | Single controlling product/design authority; canonical LF SHA-256 verified through `consolidated-design-lock.json`. | `a0a143297f2883041cac31837b19de709a8c937cbec27e91ceb4c1d2ea0e6302` |
