...
| **Data > Label** | Dominant Droplet Crop grid; 390 px outer-collapsible right panel ordered as Load Dataset, Dataset Summary, Label, Filter, and bottom-right Save As; configured Datasets may switch between two and three classes. |
