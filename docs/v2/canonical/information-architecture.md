...
| **WF §23 — Settings** | Bottom Hardware panel plus reduced Settings | Camera and DAQ technical settings move to the shell panel. Settings retains only Storage, Application Information, and Diagnostics. Detection, crop, sorting-algorithm, internal timing, and training controls are not exposed. |
