...
| **Editable crop settings** | Hidden from the user. The Droplet Crop artifact contract remains fixed, including 96 × 96 grayscale PNG output where applicable; effective configuration is recorded. |
