...
| **Models > Library** | Minimal Model rows; explicit Set Active; Add Model/Create Model and complete-package Import Model; confirmed Remove Model to the Recycle Bin subject to active, in-use, registry, and package-integrity locks; collapsible Selected Model panel. |
