...
| `UAT-ROUTE-HIL-001` | FUNCTIONAL corrected-candidate owner; VALIDATION HIL acceptance owner | Correction accepted on `7ac11368`; remaining zero-case HIL released | Candidate `4d4da434` remains rejected by the preserved physical Waste-pulse evidence. Pushed correction `7ac11368352efea62274e0f0050b5af75791c339` keys Sequence DAQ dispatch and recorded pulse status solely to finalized `observedRoute`; model `Decision` remains independent. Persistence validators were aligned without schema or atomic-I/O changes. Registered manifest/writer/service tests pass 3/3 and scoped review is FINAL ACCEPT. Frozen corrected executable SHA `E32B15A3E14ED6E286187278EFB6E26B315F64C2A6676EF3D835647D4DA97DF8`, UTC `11:50:06.826Z`, is process-free. Validation may execute only physical Waste, equality, pause, and Stop zero-output cases plus final Stop/Clear/scalar-zero. Reuse prior Hit timing, GUI, window, and unrelated evidence. |
| `FINAL-UAT-001` | VALIDATION consolidated GUI/HIL owner; FUNCTIONAL frozen-candidate/fix owner | Visible-control/layout evidence preserved; no repeat on corrected candidate | The visible UAT/window evidence from executable SHA `6F2CB565…95D64` remains accepted because correction `7ac11368` is confined to Sequence finalized-route DAQ arbitration and persistence validation. Live moving-freshness remains environment-inconclusive because the physical scene was black; nonblank retention/no-flicker passed. Do not repeat visible UAT or window testing on corrected executable SHA `E32B15A3…97DF8`; release acceptance depends only on the remaining Route HIL row. |
| `SCHED-001` | VALIDATION Route HIL owner | Corrected candidate frozen; remaining Route zero-case HIL is the critical path | Preserve every closed gate. Exercise only Waste, equality, pause, and Stop zero-output behavior plus final Stop/Clear/scalar-zero on corrected executable SHA `E32B15A3…97DF8`. Do not stamp the installer, repeat Hit/GUI/software tests, or broaden scope before the HIL disposition. |
