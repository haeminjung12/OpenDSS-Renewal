...
- runs `env-check`
- updates the OpenDSS app setting to use `%LOCALAPPDATA%\OpenVisualDropletSorter\training-venv\Scripts\python.exe`
...
.\scripts\windows\install-training-gpu-cu128.ps1 -VenvPath "$env:LOCALAPPDATA\OpenVisualDropletSorter\training-venv-gpu"
```
