...
$requirements = Resolve-Path (Join-Path $PSScriptRoot "..\..\requirements\windows-py312-gpu-cu128.txt")
$source = Resolve-Path $TrainerSourcePath

Write-Host "Installing CUDA 12.8 training dependencies from $requirements"
